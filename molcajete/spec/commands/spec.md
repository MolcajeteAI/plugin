...
- For each new or modified UC: list slice IDs (UC-XXXX-NNN) with their `covers` lists and `test_file` paths the CodeWriter will materialize at build time.
